...
interface ApiService {
    @GET("popular")
    suspend fun  getAllPopularMovies(@Query("api_key") apiKey : String, @Query("page") page : Int): Response<MovieResponse>

    @GET("upcoming")
    suspend fun getAllUpComingMovies(@Query("api_key") apiKey : String, @Query("page") page : Int): Response<MovieResponse>
